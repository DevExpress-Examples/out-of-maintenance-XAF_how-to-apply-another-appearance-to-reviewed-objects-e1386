...
Partial Public Class [Default]
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		contextMenu = New ContextActionsMenu(Me, "RecordEdit", "ObjectsCreation", "ListView", "Reports")
	...
	Public Sub SetCaption(ByVal caption As String) Implements IWindowTemplate.SetCaption
		Header.Title = CStr(IIf(String.IsNullOrEmpty(caption), caption, System.Web.HttpUtility.HtmlEncode(caption)))
	End Sub
