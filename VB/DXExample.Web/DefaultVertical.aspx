<%@ Page Language="vb" AutoEventWireup="true" Inherits="DefaultVertical" EnableViewState="false" validateRequest="false" Codebehind="DefaultVertical.aspx.vb" %>
<%@ Register Assembly="DevExpress.Web.v9.3" Namespace="DevExpress.Web.ASPxRoundPanel" TagPrefix="dxrp" %>
<%@ Register Assembly="DevExpress.Web.v9.3" Namespace="DevExpress.Web.ASPxPanel" TagPrefix="dxrp" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v9.3" Namespace="DevExpress.ExpressApp.Web.Templates.ActionContainers" TagPrefix="cc2" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v9.3" Namespace="DevExpress.ExpressApp.Web.Controls" TagPrefix="cc4" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v9.3" Namespace="DevExpress.ExpressApp.Web.Templates.Controls" TagPrefix="tc" %>
                    ...
                    <dxrp:ASPxRoundPanel ID="ToolsRoundPanel" runat="server" Width="100%" HeaderText="Tools">
                     <PanelCollection>
                         <dxrp:PanelContent ID="PanelContent1" runat="server">
                               <cc2:WebActionContainer id="VerticalToolsActionContainer" runat="server" CssClass="VContainer" ContainerId="Tools" Orientation="Vertical" ContainerStyle="Links" ></cc2:WebActionContainer>
                         </dxrp:PanelContent>
                     </PanelCollection>
                    </dxrp:ASPxRoundPanel>
                </td>
