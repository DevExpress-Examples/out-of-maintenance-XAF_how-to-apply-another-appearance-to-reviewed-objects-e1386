...
Namespace DXExample.Win
	Partial Public Class DXExampleWindowsFormsApplication
		...
		Private Sub InitializeComponent()
			...
			Me.conditionalFormattingModule1 = New DevExpress.ExpressApp.ConditionalFormatting.ConditionalFormattingModule()
			...
			Me.authenticationStandard1.UserType = GetType(DXExample.Module.MySimpleUser)
			' 
			...
			Me.Modules.Add(Me.conditionalFormattingModule1)
...
'			Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.DXExampleWindowsFormsApplication_DatabaseVersionMismatch);
		...
		Private conditionalFormattingModule1 As DevExpress.ExpressApp.ConditionalFormatting.ConditionalFormattingModule
	End Class
End Namespace
